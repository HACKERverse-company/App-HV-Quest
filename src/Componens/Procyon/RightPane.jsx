      ...
      case 'developer':
        return (
          <div className="flex flex-col items-center justify-center h-full w-full rounded-md">
            <iframe
              title="Guacamole Server"
              src="https://procyon-guacamole-5gz4c7f7qi.hackerverse.quest/guacamole/#/client/MgBjAG15c3Fs?username=guacadmin&password=guacadmin"
              className="h-full w-full border-0"
            />
          </div>
        );
    ...
    <>
      <div className="flex-1 bg p-4 overflow-auto rounded-lg h-full mr-3 -mt-2">
        <div className="tabs flex p-2 rounded-t-lg">
          ...
          >
            Developer Machine
            <a href="https://procyon-guacamole-5gz4c7f7qi.hackerverse.quest/guacamole/#/client/MgBjAG15c3Fs?username=guacadmin&password=guacadmin" target="_blank">
            <FontAwesomeIcon icon={faExternalLinkAlt}  className='ml-2 h-[12px] w-[12px] mb-[1px]'/>
            </a>          </button>
          <button
          ...
          >
            Schedule a demo
            <a href="https://info.procyon.ai/demo" target="_blank">
            <FontAwesomeIcon icon={faExternalLinkAlt}  className='ml-2 h-[12px] w-[12px] mb-[1px]'/>
            </a>          </button>
        </div>
