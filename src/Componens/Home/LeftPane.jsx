  ...
  const taskContents = [
    ...
    },
    {
      ...
      steps: [
        ...
        'In the bottom right corner, open the task bar, and open the Procyon agent.',
        'Click on the icon that looks like a Web Browser Window (Chrome should bring up the Procyon UI)',
        'On the left side navigation, select "Sessions"',
        'Click on the "Connect" button next to the target server',
        'Use the credentials provided to log in to the server',
      ],
    },
      ...
      <div className="content h-full mt-4">
        {activeTab === 'introduction' && (
          <div className="h-[calc(100vh-200px)] overflow-auto custom-scrollbar p-4">
            <h1 className="text-white text-2xl mb-4">Introduction Story</h1>
        ...
        {activeTab === 'diagrams' && (
          <div>
            <h1 className="text-white text-2xl mb-4">Diagrams and Docs</h1>
